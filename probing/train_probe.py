            ...
            for drc_tick in drc_ticks:
                ...
                for drc_channel in drc_channels:
                    ...
                    for linear in linears:
                        ...
                        train_dataset = torch.load(f"./data/train_data_full.pt") #torch.load(f"./data/MINItrain_data_{data_subset}.pt")
...
if __name__ == "__main__":
    ...
    for feature in ["stuck"]:
        for data_subset in ["random"]:
            channels = [[i] for i in list(range(32,64))]
            ...
            results_df.to_csv(f"./results/NEW{filename}_{data_subset}.csv")
