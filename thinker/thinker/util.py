...
def get_parser():
    ...
    parser.add_argument(
        "--return_norm_b", default=1, type=float, help="Minimum normalization coef"
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="Reward / value encoding type for the critic; \
                            0 for no encoding, \
    ...
    # Curiosity reward settings [Not used in the paper]
    parser.add_argument(
        "--cur_cost",
        default=0,
        type=float,
        help="Curiosity reward cost/multiplier. 0 for no curiosity.",
    )
    parser.add_argument(
        "--cur_im_cost",
        default=0,
        type=float,
        help="Curiosity reward - imagainary action cost/multiplier.",
    )
    parser.add_argument(
        "--cur_reward_cost",
        default=0,
        type=float,
        help="Coefficient of reward loss for computing curiosity reward.",
    )
    parser.add_argument(
        "--cur_v_cost",
        default=0,
        type=float,
        help="Coefficient of value loss for computing curiosity reward.",
    )
    parser.add_argument(
        "--cur_enc_cost",
        default=0,
        type=float,
        help="Coefficient of encoding loss for computing curiosity reward.",
    )
    parser.add_argument(
        "--disable_cur_anneal",
        action="store_false",
        dest="cur_cost_anneal",
    ...
    parser.add_argument(
        ...
        default=1000000,
        type=int,
        help="The real step that begins giving curiosity reward.",
    )
    ...
    parser.add_argument(
        ...
        default=1.0,
        type=float,
        help="Gradient scale for RNN in actor network.",
    )
    ...
    parser.add_argument(
        ...
        default=1.0,
        type=float,
        help="Discounting factor for planning reward based on search depth.",
    )
    parser.add_argument(
