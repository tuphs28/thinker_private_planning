...
class ConvAttnLSTMCell(nn.Module):
    ...
    def __init__(self, input_dims, embed_dim, kernel_size=3, num_heads=8, mem_n=8, attn=True, attn_mask_b=5, legacy=False):
...
class ConvAttnLSTM(nn.Module):
    ...
    def __init__(self, h, w, input_dim, hidden_dim, kernel_size, 
            num_layers, num_heads, mem_n, attn, attn_mask_b, legacy=False):
